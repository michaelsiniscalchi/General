function colors = setPlotColors( experiment )

cbrew = brewColorSwatches;

switch experiment
    case {'mjs_taskLearningWalls', 'mjs_taskLearning_VTA_1', 'mjs_tactile2visual'}
        colors = struct(...
            ...
            'predictor',struct('towers', cbrew.black, 'puffs', cbrew.black,'priorChoice', cbrew.black, 'bias', cbrew.black,... %GLM Predictors
            'congruent', cbrew.black, 'conflict', cbrew.black,'priorRewChoice',cbrew.green,'priorUnrewChoice',cbrew.pink),...%GLM Predictors
            ...
            'median_response_delay',cbrew.black,'median_response_bias',cbrew.red,...
            'bias',cbrew.red,...
            'level',[repmat(cbrew.gray,6,1);cbrew.blue; cbrew.blue; cbrew.purple; cbrew.purple],...
            'taskRule',struct('forcedChoice',cbrew.gray,...
            'tactile',cbrew.purple,'visual',cbrew.blue,'alternation',cbrew.red)); %Maze level
    ...
    otherwise
        colors = struct(...
            ...
            'taskRule',struct('forcedChoice',cbrew.gray,...
            'tactile',cbrew.purple,'visual',cbrew.blue,'alternation',cbrew.red));
end
